...
RUN sed -i 's/deb.debian.org/mirrors.ustc.edu.cn/g' /etc/apt/sources.list.d/debian.sources && \
  ...
  libopenmpt0 libopus0 libtcmalloc-minimal4 libtheora0 libvorbisenc2 libvpx7 libwebp7 libpci3 \
  libwebpmux3 libx264-164 libx265-199 libzvbi0 libjemalloc2 ocl-icd-libopencl1 intel-opencl-icd \
  clinfo && apt clean && rm -rf /var/lib/apt/lists/*
